  ...
  if (typeof define === 'function' && define.amd) {
    ...
    $[_PLUGIN_].prototype = {
        ...
        settingDOM : function (){
            ...
            var ulDOM = this.container.find('.dnSlide-list');
        ...
        dnSlideRotate : function(dir){
            var self_ = this ,
                indexArr = [] ,
                arr      = [] ;
            $('.dnSlide-item').removeClass('active');
            if(dir==='left'){
                this.activeIndex=(this.activeIndex+1)>4?0:(this.activeIndex+1);
                this.dnSlideItems.find('li').each(function(index, el) {
                    if(index==self_.activeIndex){
                        setTimeout(function () {
                            $(el).addClass('active')
                        },300)
                    }
                ...
                this.activeIndex=(this.activeIndex-1)<0?4:(this.activeIndex-1);
                this.dnSlideItems.find('li').each(function(index, el) {
                    if(index==self_.activeIndex){
                        setTimeout(function () {
                            $(el).addClass('active')
